        ...
        <div class="container">
            ...
            <div class="row"><?php echo $column_left; ?>
                ...
                <div id="content" class="<?php echo $class; ?> centered"><?php echo $content_top; ?>
                    ...
                    <p class="pink-style"><?php echo $text_account_already; ?></p>
                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data"
                        ...
                        <div class="buttons">
                            ...
                            <div class="agree-box">
                                ...
                                <label>
                                    <?php if ($agree) { ?>
                                    <input required class="agree__check" type="checkbox" name="agree" value="1" checked="checked"/>

                                    <?php } else { ?>
                                    <input required class="agree__check" type="checkbox" name="agree" value="0"/>
                                    <?php } ?>
                                    <?php echo $text_agree; ?>
                                </label>
                                <!--<div>
