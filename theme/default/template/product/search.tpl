...
<main>
    <div class="container"id="breadcrumb">
        <ul class="breadcrumb">
            ...
            <li>
                <a href="<?php echo $breadcrumb['href']; ?>"><?php echo isset($breadcrumb['img']) ? '<img src="/image/' . $breadcrumb['img'] . '">
                    ' : $breadcrumb['text']; ?></a>
            </li>
    ...
    <div class="container">
        <div class="row"><?php echo $column_left; ?>
            ...
            <?php $class = 'col-sm-12'; ?>
            <?php } ?>
            <div id="content" class="<?php echo $class; ?> search"><?php echo $content_top; ?>
                <h1 class="search__title"><?php echo $heading_title; ?></h1>
                <div class="row">
                    <div class="width-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3 search__checkbox">
                                <label class="checkbox-inline">
                                    <?php if ($sub_category) { ?>
                                    <input type="checkbox" name="sub_category" value="1" checked="checked" class="agree__check"/>
                                    <?php } else { ?>
                        ...
                        <input type="button" value="<?php echo $button_search; ?>" id="button-search" class="button btn__search"/>
                    </div>
                                ...
                                <div class="product-thumb">
                                    ...
                                    <div>
                                        ...
                                        <div class="button-group">
                                            ...
                                            <button class="button button-search button__search--icon" type="button" data-toggle="tooltip"
