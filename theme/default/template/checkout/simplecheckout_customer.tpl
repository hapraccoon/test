...
<div class="checkout-heading panel-heading checkout-heading__trans">
  <span><?php echo $text_checkout_customer ?></span>
  <?php if ($display_login) { ?><span class=""><a class="zakaz-reg" href="javascript:void(0)" data-onclick="openLoginBox"><?php echo $text_checkout_customer_login ?></a></span><?php } ?>
</div>
<?php } ?>
